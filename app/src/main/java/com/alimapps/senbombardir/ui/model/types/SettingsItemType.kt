...
enum class SettingsItemType(val iconRes: Int, val stringRes: Int) {
    Language(iconRes = R.drawable.ic_language, stringRes = R.string.settings_item_language),
    ...
    Activation(iconRes = R.drawable.ic_star_shine, stringRes = R.string.settings_item_activation),
}